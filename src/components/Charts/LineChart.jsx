  ...
  return (
    ...
    >
      ...
      <SeriesCollectionDirective>
        {lineCustomSeries.map((item, i) => <SeriesDirective key={i} dataSource={item.dataSource} xName={item.xName} yName={item.yName} name={item.name} width={item.width} marker={item.marker} type={item.type} />)}
      </SeriesCollectionDirective>
    </ChartComponent>
